 ...
 * @method static array applePromotionalOfferSignature(string $productIdentifier, string $subscriptionOfferId, string $appAccountToken = '', ?string $nonce = null, ?int $timestamp = null)
 * @method static string applePromotionalOfferJws(string $productId, string $offerIdentifier, ?string $transactionId = null, ?string $nonce = null)
 ...
 * @method static \Lemoba\MobileMonetization\Payments\VerifiedPurchase verifyGoogleProduct(?string $productId = null, ?string $purchaseToken = null)
 * @method static \Lemoba\MobileMonetization\Payments\VerifiedPurchase verifyAndConsumeGoogleProduct(?string $productId = null, ?string $purchaseToken = null)
 * @method static array parseGoogleOrderNo(string $purchaseToken)
 * @method static \Lemoba\MobileMonetization\Payments\VerifiedPurchase verifyGoogleSubscription(?string $subscriptionId = null, ?string $purchaseToken = null, ?string $productId = null)
 * @method static array verifyGoogleSubscriptionOffer(?string $subscriptionId = null, ?string $purchaseToken = null, ?string $expectedBasePlanId = null, ?string $expectedOfferId = null, ?string $productId = null)
